...
class Docx {
    ...
    static prepareJSONForRephpasing(json) {
        ...
        const result = p.map((p) => {
            ...
            obj.query =
                "Прошу тебя выступить в роли профессионального копирайтера и переосмыслить предоставленный текст, используя синонимы, чтобы создать уникальную версию, в которой используется естественный стиль. Пожалуйста, сохраните исходное форматирование и смысл текста, придерживаясь красивого литературного языка и избегая стилистических и грамматических ошибок. Обратите внимание, что общий объем текста не должен превышать исходный более чем на 10%. Предоставленный текст будет разделен на части, однако помните, что он образует единую целостность. Пожалуйста, обеспечь высокую сложность и разнообразие контента, чтобы избежать повторов и успешно пройти проверку на уникальность.";
